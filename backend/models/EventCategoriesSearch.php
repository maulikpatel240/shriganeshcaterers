...
/**
 * EventCategoriesSearch represents the model behind the search form of `backend\models\EventCategories`.
 */
class EventCategoriesSearch extends EventCategories {
    ...
    public function search($params, $pageSize) {
        $query = (isset($params['sort']) && $params['sort']) ? EventCategories::find() : EventCategories::find()->orderBy(['id' => SORT_DESC]);
