...
/**
 * ItemsController implements the CRUD actions for ItemsItems model.
 */
    ...
    public function actionCreate() {
        ...
        if (Yii::$app->request->isAjax) {
            ...
            if ($model->load(Yii::$app->request->post())) {
                ...
                $modelItems = Model::createMultiple(Items::classname());
                ...
                if($modelItems){
                    foreach ($modelItems as $key => $value){
                        ...
                        $modelNew->item_category_id = $model->item_category_id;
            ...
            return $this->renderAjax('create', [
                        'model' => $model,
                        'modelItems' => (empty($modelItems)) ? [$model] : $modelItems
            ]);
        }
    }
