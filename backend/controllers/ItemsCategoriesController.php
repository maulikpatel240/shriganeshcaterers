...
use backend\models\ItemsCategoriesSearch;
...
/**
 * ItemsCategoriesController implements the CRUD actions for ItemsCategories model.
 */
class ItemsCategoriesController extends BaseController {
    ...
    public function actionIndex() {
        ...
        $searchModel = new ItemsCategoriesSearch();
