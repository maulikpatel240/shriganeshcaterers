...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed position-relative">
        ...
        <?php if ($adminuser) { ?>
            ...
            <div class="wrapper">
                ...
                <aside class="main-sidebar sidebar-dark-primary elevation-4">
                    ...
                    <a href="index3.html" class="brand-link navbar-gray-dark">
                        ...
                        <span class="brand-text font-weight-light">Shri Ganesh Caterers</span>
                    </a>
                                ...
                                foreach ($modules as $key => $value) {
                                    ...
                                    if ($menus) {
                                        foreach ($menus as $key_menu => $value_menu) {
                                                ...
                                                foreach ($submenu as $key_submenu => $value_submenu) {
                                                    ...
                                                    if (!empty(Yii::$app->BackFunctions->checkaccess($value_submenu['action'], $value_submenu['controller']))) {
                                                        $childMenu .= '<li class="nav-item">'
                                                                ...
                                                                . $childInMenu
                                                                . '</li>';
                                                        $submenu_permission[] = Yii::$app->BackFunctions->checkaccess($value_submenu['action'], $value_submenu['controller']);
                                                    }
                                                }
                                                $childMenu .= "</ul>";
                                            ...
                                            //echo '<pre>'; print_r($submenu_permission);echo '</pre>';
                                            //echo '<pre>'; print_r($value_menu['controller'].' '.Yii::$app->BackFunctions->checkaccess($value_menu['action'], $value_menu['controller']));echo '</pre>';
            ...
            echo \Yii::$app->view->renderFile('@app/views/site/error.php', ['name' => '404', 'message' => '']);
        }
        ?>
    </body>
</html>
