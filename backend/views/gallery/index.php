...
if (!empty(Yii::$app->BackFunctions->checkaccess('create', Yii::$app->controller->id))) {
    $createBtn = Html::a('<i class="fas fa-plus"></i>', FALSE, ['value' => Url::to(['gallery/create']), 'title' => 'Create gallery', 'class' => 'showModalButton btn btn-primary']);
}
//Export
$exportBtn = '';
...
//                                    ],
                        [
                            ...
                            'value' => function ($model) {
                                $imagesrc = Html::img(Yii::$app->urlManager->baseUrl . '/uploads/gallery/' . $model->value, ['width' => '70', 'height' => '70', 'class' => 'img-circle', 'onerror' => "this.onerror=null;this.src='" . Yii::$app->params['default_error_img'] . "';"]);
                                $imagehtml = Html::a($imagesrc, Yii::$app->urlManager->baseUrl . '/uploads/gallery/' . $model->value, ['data-fancybox' => true]);
                                ...
                                if (!empty(Yii::$app->BackFunctions->checkaccess('status', Yii::$app->controller->id))) {
                                    return Html::a($model->status,
                                                    ...
                                                    [
                                                        ...
                                                        'title' => $model->status,
                                                        'onclick' => '$.post({
                                                            url: "' . Yii::$app->homeUrl . 'gallery/statusupdate?id=' . $model->id . '",
                                ...
                                'view' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('view', Yii::$app->controller->id))) {
                                        return Html::a(
                                                        ...
                                                        FALSE,
                                                        [
                                                            'value' => Url::to(['gallery/view', 'id' => $model->id]),
                                                            'title' => 'View Category',
                                ...
                                'update' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('update', Yii::$app->controller->id))) {
                                        return Html::a(
                                                        ...
                                                        FALSE,
                                                        [
                                                            'value' => Url::to(['gallery/update', 'id' => $model->id]),
                                                            'title' => 'Edit Category',
...
<script type="text/javascript">
    function applyjs(e) {
        ...
        if (confirmalert == true) {
            ...
            $.post({
                url: '<?= Yii::$app->homeUrl . 'gallery/applystatus' ?>',
                dataType: 'json',
