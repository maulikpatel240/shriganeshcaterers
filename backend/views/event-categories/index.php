...
if (!empty(Yii::$app->BackFunctions->checkaccess('create', Yii::$app->controller->id))) {
    $createBtn = Html::a('<i class="fas fa-plus"></i>', FALSE, ['value' => Url::to(['event-categories/create']), 'title' => 'Create event category', 'class' => 'showModalButton btn btn-primary']);
}
//Export
$exportBtn = '';
...
//                                    ],
                                ...
                                if (!empty(Yii::$app->BackFunctions->checkaccess('status', Yii::$app->controller->id))) {
                                    return Html::a($model->status,
                                                    ...
                                                    [
                                                        ...
                                                        'title' => $model->status,
                                                        'onclick' => '$.post({
                                                            url: "' . Yii::$app->homeUrl . 'event-categories/statusupdate?id=' . $model->id . '",
                                ...
                                'view' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('view', Yii::$app->controller->id))) {
                                        return Html::a(
                                                        ...
                                                        FALSE,
                                                        [
                                                            'value' => Url::to(['event-categories/view', 'id' => $model->id]),
                                ...
                                'update' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('update', Yii::$app->controller->id))) {
                                        return Html::a(
                                                        ...
                                                        FALSE,
                                                        [
                                                            'value' => Url::to(['event-categories/update', 'id' => $model->id]),
                    ...
                    'itemLabelSingle' => 'Event Category',
                    'itemLabelPlural' => 'Event Categories',
                ]);
                ?>
            </div>
        </div>
...
<script type="text/javascript">
    function applyjs(e) {
        ...
        if (confirmalert == true) {
            ...
            $.post({
                url: '<?= Yii::$app->homeUrl . 'event-categories/applystatus' ?>',
                dataType: 'json',
