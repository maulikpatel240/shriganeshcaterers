...
<div class="carousel-form">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-6">
            ...
            <?= $form->field($model, 'description_english')->textarea(['rows' => 4]) ?>
        </div>
        <div class="col-sm-12 col-md-6 col-lg-6">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6">
            <?= $form->field($model, 'title_gujarati')->textInput(['maxlength' => true]) ?>
            <?= $form->field($model, 'description_gujarati')->textarea(['rows' => 4]) ?>
        </div>
        <div class="col-sm-12 col-md-6 col-lg-6">
            <?= $form->field($model, 'title_hindi')->textInput(['maxlength' => true]) ?>
            <?= $form->field($model, 'description_hindi')->textarea(['rows' => 4]) ?>
        </div>
    </div>
