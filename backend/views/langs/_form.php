            ...
            <div class="panel-body container-items">
                <?php foreach ($modelLangs as $key => $value): ?>
                    <div class="item panel panel-default shadow p-3 mb-3">
                        <div class="panel-heading text-red text-bold text-center border-bottom">
...
//                        }
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <?php echo $form->field($value, "[$key]english")->textInput(['maxlength' => true]) ?>
                                </div>
                                <div class="col-sm-6">
                                    <?php //echo $form->field($value, "[$key]gujarati")->textarea(['rows' => 2]) ?>
                                    <?php echo $form->field($value, "[$key]gujarati")->textInput(['maxlength' => true]) ?>
                                </div>
                                <div class="col-sm-6">
                                    <?php //echo $form->field($value, "[$key]hindi")->textarea(['rows' => 2]) ?>
                                    <?php echo $form->field($value, "[$key]hindi")->textInput(['maxlength' => true]) ?>
                                </div>
                            </div>
                        </div>
                        <div class="">
