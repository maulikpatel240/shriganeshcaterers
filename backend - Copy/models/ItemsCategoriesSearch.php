...
/**
 * ItemsCategoriesSearch represents the model behind the search form of `backend\models\ItemsCategories`.
 */
class ItemsCategoriesSearch extends ItemsCategories
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = (isset($params['sort']) && $params['sort']) ? ItemsCategories::find() : ItemsCategories::find()->orderBy(['id' => SORT_DESC]);
